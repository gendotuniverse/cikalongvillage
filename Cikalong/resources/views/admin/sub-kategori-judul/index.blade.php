...
@section('content')
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Sub Kategori Judul</h3>
        </div>

        <div class="ms-md-auto py-2 py-md-0">
            <a href="{{ url('admin/sub-kategori-judul/create') }}" class="btn btn-primary btn-round"><i
                    class="fas fa-plus"></i>
                Tambah</a>
        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($result as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->name }}</td>
                                            <td>
                                                <a href="/admin/sub-kategori-judul/{{ $item->id }}/edit"
