...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    {!! Form::open(['method' => 'post', 'route' => ['admin.pemerintahan.store'], 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jabatan" class="form-control" value="{{ old('jabatan') }}" placeholder="Jabatan" autocomplete="off">
